      ...
      >
        ...
        <View style={styles.cardContainer}>
          <Card
            ...
            iconSymbol={<Entypo name="plus" size={24} color={theme.colors.background.default} />}
          ...
          <Card
            ...
            iconSymbol={<Fontisto name="arrow-right-l" size={24} color={theme.colors.background.default} />}
