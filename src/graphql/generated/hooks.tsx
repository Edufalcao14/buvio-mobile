...
export type VotingSessionStateFragment = { __typename?: 'VotingSession', id: string, status: VoteSessionStatus, timeRemaining: number, closingAt?: any | null, closedAt?: any | null, closedReason?: VoteClosureReason | null, startedBy: { __typename?: 'User', id: string, displayName: string, nickname?: string | null }, match: { __typename?: 'Match', id: string, name: string, date: any }, ballots: Array<{ __typename?: 'BallotProgress', hasTop: boolean, hasFlop: boolean, isComplete: boolean, player: { __typename?: 'User', id: string, displayName: string, nickname?: string | null, avatarUrl?: string | null } }>, tally: Array<{ __typename?: 'TallyEntry', topCount: number, flopCount: number, player: { __typename?: 'User', id: string, displayName: string, nickname?: string | null, avatarUrl?: string | null } }>, voteResult?: { __typename?: 'VoteResult', top: { __typename?: 'User', id: string, displayName: string, nickname?: string | null, avatarUrl?: string | null }, flop: { __typename?: 'User', id: string, displayName: string, nickname?: string | null, avatarUrl?: string | null } } | null };
...
export type CreateVotingSessionMutation = { __typename?: 'Mutation', createVotingSession: { __typename?: 'VotingSession', id: string, status: VoteSessionStatus, timeRemaining: number, closingAt?: any | null, closedAt?: any | null, closedReason?: VoteClosureReason | null, startedBy: { __typename?: 'User', id: string, displayName: string, nickname?: string | null }, match: { __typename?: 'Match', id: string, name: string, date: any }, ballots: Array<{ __typename?: 'BallotProgress', hasTop: boolean, hasFlop: boolean, isComplete: boolean, player: { __typename?: 'User', id: string, displayName: string, nickname?: string | null, avatarUrl?: string | null } }>, tally: Array<{ __typename?: 'TallyEntry', topCount: number, flopCount: number, player: { __typename?: 'User', id: string, displayName: string, nickname?: string | null, avatarUrl?: string | null } }>, voteResult?: { __typename?: 'VoteResult', top: { __typename?: 'User', id: string, displayName: string, nickname?: string | null, avatarUrl?: string | null }, flop: { __typename?: 'User', id: string, displayName: string, nickname?: string | null, avatarUrl?: string | null } } | null } };
...
export type CloseVotingSessionMutation = { __typename?: 'Mutation', closeVotingSession: { __typename?: 'VotingSession', id: string, status: VoteSessionStatus, timeRemaining: number, closingAt?: any | null, closedAt?: any | null, closedReason?: VoteClosureReason | null, startedBy: { __typename?: 'User', id: string, displayName: string, nickname?: string | null }, match: { __typename?: 'Match', id: string, name: string, date: any }, ballots: Array<{ __typename?: 'BallotProgress', hasTop: boolean, hasFlop: boolean, isComplete: boolean, player: { __typename?: 'User', id: string, displayName: string, nickname?: string | null, avatarUrl?: string | null } }>, tally: Array<{ __typename?: 'TallyEntry', topCount: number, flopCount: number, player: { __typename?: 'User', id: string, displayName: string, nickname?: string | null, avatarUrl?: string | null } }>, voteResult?: { __typename?: 'VoteResult', top: { __typename?: 'User', id: string, displayName: string, nickname?: string | null, avatarUrl?: string | null }, flop: { __typename?: 'User', id: string, displayName: string, nickname?: string | null, avatarUrl?: string | null } } | null } };
...
export type VoteMatchQuery = { __typename?: 'Query', me: { __typename?: 'Me', id: string, displayName: string, nickname?: string | null, avatarUrl?: string | null }, getMatchById: { __typename?: 'Match', id: string, name: string, date: any, type: MatchType, players: Array<{ __typename?: 'User', id: string, displayName: string, nickname?: string | null, avatarUrl?: string | null }>, votingSession?: { __typename?: 'VotingSession', id: string, status: VoteSessionStatus, timeRemaining: number, closingAt?: any | null, closedAt?: any | null, closedReason?: VoteClosureReason | null, startedBy: { __typename?: 'User', id: string, displayName: string, nickname?: string | null }, match: { __typename?: 'Match', id: string, name: string, date: any }, ballots: Array<{ __typename?: 'BallotProgress', hasTop: boolean, hasFlop: boolean, isComplete: boolean, player: { __typename?: 'User', id: string, displayName: string, nickname?: string | null, avatarUrl?: string | null } }>, tally: Array<{ __typename?: 'TallyEntry', topCount: number, flopCount: number, player: { __typename?: 'User', id: string, displayName: string, nickname?: string | null, avatarUrl?: string | null } }>, voteResult?: { __typename?: 'VoteResult', top: { __typename?: 'User', id: string, displayName: string, nickname?: string | null, avatarUrl?: string | null }, flop: { __typename?: 'User', id: string, displayName: string, nickname?: string | null, avatarUrl?: string | null } } | null } | null } };
...
export type VotingSessionUpdatedSubscription = { __typename?: 'Subscription', votingSessionUpdated: { __typename?: 'VotingSession', id: string, status: VoteSessionStatus, timeRemaining: number, closingAt?: any | null, closedAt?: any | null, closedReason?: VoteClosureReason | null, startedBy: { __typename?: 'User', id: string, displayName: string, nickname?: string | null }, match: { __typename?: 'Match', id: string, name: string, date: any }, ballots: Array<{ __typename?: 'BallotProgress', hasTop: boolean, hasFlop: boolean, isComplete: boolean, player: { __typename?: 'User', id: string, displayName: string, nickname?: string | null, avatarUrl?: string | null } }>, tally: Array<{ __typename?: 'TallyEntry', topCount: number, flopCount: number, player: { __typename?: 'User', id: string, displayName: string, nickname?: string | null, avatarUrl?: string | null } }>, voteResult?: { __typename?: 'VoteResult', top: { __typename?: 'User', id: string, displayName: string, nickname?: string | null, avatarUrl?: string | null }, flop: { __typename?: 'User', id: string, displayName: string, nickname?: string | null, avatarUrl?: string | null } } | null } };
...
export const SignUpDocument = gql`
    mutation SignUp($email: String!, $password: String!, $displayName: String!, $nickname: String) {
  createUser(
    email: $email
    password: $password
...
// @ts-ignore
export function useValidateTeamCodeSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<ValidateTeamCodeQuery, ValidateTeamCodeQueryVariables>): Apollo.UseSuspenseQueryResult<ValidateTeamCodeQuery, ValidateTeamCodeQueryVariables>;
export function useValidateTeamCodeSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<ValidateTeamCodeQuery, ValidateTeamCodeQueryVariables>): Apollo.UseSuspenseQueryResult<ValidateTeamCodeQuery | undefined, ValidateTeamCodeQueryVariables>;
...
// @ts-ignore
export function useGetTeamMembersSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<GetTeamMembersQuery, GetTeamMembersQueryVariables>): Apollo.UseSuspenseQueryResult<GetTeamMembersQuery, GetTeamMembersQueryVariables>;
export function useGetTeamMembersSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<GetTeamMembersQuery, GetTeamMembersQueryVariables>): Apollo.UseSuspenseQueryResult<GetTeamMembersQuery | undefined, GetTeamMembersQueryVariables>;
 ...
 * });
 */
export function useTeamHistoryQuery(baseOptions?: Apollo.QueryHookOptions<TeamHistoryQuery, TeamHistoryQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<TeamHistoryQuery, TeamHistoryQueryVariables>(TeamHistoryDocument, options);
      }
export function useTeamHistoryLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<TeamHistoryQuery, TeamHistoryQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<TeamHistoryQuery, TeamHistoryQueryVariables>(TeamHistoryDocument, options);
        }
// @ts-ignore
export function useTeamHistorySuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<TeamHistoryQuery, TeamHistoryQueryVariables>): Apollo.UseSuspenseQueryResult<TeamHistoryQuery, TeamHistoryQueryVariables>;
export function useTeamHistorySuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<TeamHistoryQuery, TeamHistoryQueryVariables>): Apollo.UseSuspenseQueryResult<TeamHistoryQuery | undefined, TeamHistoryQueryVariables>;
export function useTeamHistorySuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<TeamHistoryQuery, TeamHistoryQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<TeamHistoryQuery, TeamHistoryQueryVariables>(TeamHistoryDocument, options);
        }
export type TeamHistoryQueryHookResult = ReturnType<typeof useTeamHistoryQuery>;
export type TeamHistoryLazyQueryHookResult = ReturnType<typeof useTeamHistoryLazyQuery>;
export type TeamHistorySuspenseQueryHookResult = ReturnType<typeof useTeamHistorySuspenseQuery>;
export type TeamHistoryQueryResult = Apollo.QueryResult<TeamHistoryQuery, TeamHistoryQueryVariables>;
 ...
 * });
 */
export function useTeamVoteStateQuery(baseOptions?: Apollo.QueryHookOptions<TeamVoteStateQuery, TeamVoteStateQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<TeamVoteStateQuery, TeamVoteStateQueryVariables>(TeamVoteStateDocument, options);
      }
export function useTeamVoteStateLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<TeamVoteStateQuery, TeamVoteStateQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<TeamVoteStateQuery, TeamVoteStateQueryVariables>(TeamVoteStateDocument, options);
        }
// @ts-ignore
export function useTeamVoteStateSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<TeamVoteStateQuery, TeamVoteStateQueryVariables>): Apollo.UseSuspenseQueryResult<TeamVoteStateQuery, TeamVoteStateQueryVariables>;
export function useTeamVoteStateSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<TeamVoteStateQuery, TeamVoteStateQueryVariables>): Apollo.UseSuspenseQueryResult<TeamVoteStateQuery | undefined, TeamVoteStateQueryVariables>;
export function useTeamVoteStateSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<TeamVoteStateQuery, TeamVoteStateQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<TeamVoteStateQuery, TeamVoteStateQueryVariables>(TeamVoteStateDocument, options);
        }
export type TeamVoteStateQueryHookResult = ReturnType<typeof useTeamVoteStateQuery>;
export type TeamVoteStateLazyQueryHookResult = ReturnType<typeof useTeamVoteStateLazyQuery>;
export type TeamVoteStateSuspenseQueryHookResult = ReturnType<typeof useTeamVoteStateSuspenseQuery>;
export type TeamVoteStateQueryResult = Apollo.QueryResult<TeamVoteStateQuery, TeamVoteStateQueryVariables>;
...
export const CreateAvatarUploadUrlDocument = gql`
  ...
  createAvatarUploadUrl(contentType: $contentType) {
    ...
    `;
export type CreateAvatarUploadUrlMutationFn = Apollo.MutationFunction<CreateAvatarUploadUrlMutation, CreateAvatarUploadUrlMutationVariables>;
 ...
 * });
 */
export function useCreateAvatarUploadUrlMutation(baseOptions?: Apollo.MutationHookOptions<CreateAvatarUploadUrlMutation, CreateAvatarUploadUrlMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<CreateAvatarUploadUrlMutation, CreateAvatarUploadUrlMutationVariables>(CreateAvatarUploadUrlDocument, options);
      }
export type CreateAvatarUploadUrlMutationHookResult = ReturnType<typeof useCreateAvatarUploadUrlMutation>;
export type CreateAvatarUploadUrlMutationResult = Apollo.MutationResult<CreateAvatarUploadUrlMutation>;
export type CreateAvatarUploadUrlMutationOptions = Apollo.BaseMutationOptions<CreateAvatarUploadUrlMutation, CreateAvatarUploadUrlMutationVariables>;
export const ConfirmAvatarUploadDocument = gql`
  ...
  confirmAvatarUpload(key: $key) {
    ...
    `;
export type ConfirmAvatarUploadMutationFn = Apollo.MutationFunction<ConfirmAvatarUploadMutation, ConfirmAvatarUploadMutationVariables>;
 ...
 * });
 */
export function useConfirmAvatarUploadMutation(baseOptions?: Apollo.MutationHookOptions<ConfirmAvatarUploadMutation, ConfirmAvatarUploadMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<ConfirmAvatarUploadMutation, ConfirmAvatarUploadMutationVariables>(ConfirmAvatarUploadDocument, options);
      }
export type ConfirmAvatarUploadMutationHookResult = ReturnType<typeof useConfirmAvatarUploadMutation>;
export type ConfirmAvatarUploadMutationResult = Apollo.MutationResult<ConfirmAvatarUploadMutation>;
export type ConfirmAvatarUploadMutationOptions = Apollo.BaseMutationOptions<ConfirmAvatarUploadMutation, ConfirmAvatarUploadMutationVariables>;
export const CreateTeamCrestUploadUrlDocument = gql`
  ...
  createTeamCrestUploadUrl(contentType: $contentType) {
    ...
    `;
export type CreateTeamCrestUploadUrlMutationFn = Apollo.MutationFunction<CreateTeamCrestUploadUrlMutation, CreateTeamCrestUploadUrlMutationVariables>;
 ...
 * });
 */
export function useCreateTeamCrestUploadUrlMutation(baseOptions?: Apollo.MutationHookOptions<CreateTeamCrestUploadUrlMutation, CreateTeamCrestUploadUrlMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<CreateTeamCrestUploadUrlMutation, CreateTeamCrestUploadUrlMutationVariables>(CreateTeamCrestUploadUrlDocument, options);
      }
export type CreateTeamCrestUploadUrlMutationHookResult = ReturnType<typeof useCreateTeamCrestUploadUrlMutation>;
export type CreateTeamCrestUploadUrlMutationResult = Apollo.MutationResult<CreateTeamCrestUploadUrlMutation>;
export type CreateTeamCrestUploadUrlMutationOptions = Apollo.BaseMutationOptions<CreateTeamCrestUploadUrlMutation, CreateTeamCrestUploadUrlMutationVariables>;
export const ConfirmTeamCrestUploadDocument = gql`
  ...
  confirmTeamCrestUpload(key: $key) {
    ...
    `;
export type ConfirmTeamCrestUploadMutationFn = Apollo.MutationFunction<ConfirmTeamCrestUploadMutation, ConfirmTeamCrestUploadMutationVariables>;
 ...
 * });
 */
export function useConfirmTeamCrestUploadMutation(baseOptions?: Apollo.MutationHookOptions<ConfirmTeamCrestUploadMutation, ConfirmTeamCrestUploadMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<ConfirmTeamCrestUploadMutation, ConfirmTeamCrestUploadMutationVariables>(ConfirmTeamCrestUploadDocument, options);
      }
export type ConfirmTeamCrestUploadMutationHookResult = ReturnType<typeof useConfirmTeamCrestUploadMutation>;
export type ConfirmTeamCrestUploadMutationResult = Apollo.MutationResult<ConfirmTeamCrestUploadMutation>;
export type ConfirmTeamCrestUploadMutationOptions = Apollo.BaseMutationOptions<ConfirmTeamCrestUploadMutation, ConfirmTeamCrestUploadMutationVariables>;
 ...
 * });
 */
export function useTeamRankingQuery(baseOptions?: Apollo.QueryHookOptions<TeamRankingQuery, TeamRankingQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<TeamRankingQuery, TeamRankingQueryVariables>(TeamRankingDocument, options);
      }
export function useTeamRankingLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<TeamRankingQuery, TeamRankingQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<TeamRankingQuery, TeamRankingQueryVariables>(TeamRankingDocument, options);
        }
// @ts-ignore
export function useTeamRankingSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<TeamRankingQuery, TeamRankingQueryVariables>): Apollo.UseSuspenseQueryResult<TeamRankingQuery, TeamRankingQueryVariables>;
export function useTeamRankingSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<TeamRankingQuery, TeamRankingQueryVariables>): Apollo.UseSuspenseQueryResult<TeamRankingQuery | undefined, TeamRankingQueryVariables>;
export function useTeamRankingSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<TeamRankingQuery, TeamRankingQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<TeamRankingQuery, TeamRankingQueryVariables>(TeamRankingDocument, options);
        }
export type TeamRankingQueryHookResult = ReturnType<typeof useTeamRankingQuery>;
export type TeamRankingLazyQueryHookResult = ReturnType<typeof useTeamRankingLazyQuery>;
export type TeamRankingSuspenseQueryHookResult = ReturnType<typeof useTeamRankingSuspenseQuery>;
export type TeamRankingQueryResult = Apollo.QueryResult<TeamRankingQuery, TeamRankingQueryVariables>;
export const SubmitVoteDocument = gql`
    mutation SubmitVote($votingSession: ID!, $votedUserId: ID!, $type: VoteType!, $description: String) {
  submitVote(
    votingSession: $votingSession
    ...
    `;
export type SubmitVoteMutationFn = Apollo.MutationFunction<SubmitVoteMutation, SubmitVoteMutationVariables>;
 ...
 * });
 */
export function useSubmitVoteMutation(baseOptions?: Apollo.MutationHookOptions<SubmitVoteMutation, SubmitVoteMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<SubmitVoteMutation, SubmitVoteMutationVariables>(SubmitVoteDocument, options);
      }
export type SubmitVoteMutationHookResult = ReturnType<typeof useSubmitVoteMutation>;
export type SubmitVoteMutationResult = Apollo.MutationResult<SubmitVoteMutation>;
export type SubmitVoteMutationOptions = Apollo.BaseMutationOptions<SubmitVoteMutation, SubmitVoteMutationVariables>;
...
export type CreateVotingSessionMutationFn = Apollo.MutationFunction<CreateVotingSessionMutation, CreateVotingSessionMutationVariables>;
 ...
 * });
 */
export function useCreateVotingSessionMutation(baseOptions?: Apollo.MutationHookOptions<CreateVotingSessionMutation, CreateVotingSessionMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<CreateVotingSessionMutation, CreateVotingSessionMutationVariables>(CreateVotingSessionDocument, options);
      }
export type CreateVotingSessionMutationHookResult = ReturnType<typeof useCreateVotingSessionMutation>;
export type CreateVotingSessionMutationResult = Apollo.MutationResult<CreateVotingSessionMutation>;
export type CreateVotingSessionMutationOptions = Apollo.BaseMutationOptions<CreateVotingSessionMutation, CreateVotingSessionMutationVariables>;
export const CloseVotingSessionDocument = gql`
  ...
  closeVotingSession(votingSessionId: $votingSessionId) {
    ...
    ${VotingSessionStateFragmentDoc}`;
export type CloseVotingSessionMutationFn = Apollo.MutationFunction<CloseVotingSessionMutation, CloseVotingSessionMutationVariables>;
 ...
 * });
 */
export function useCloseVotingSessionMutation(baseOptions?: Apollo.MutationHookOptions<CloseVotingSessionMutation, CloseVotingSessionMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<CloseVotingSessionMutation, CloseVotingSessionMutationVariables>(CloseVotingSessionDocument, options);
      }
export type CloseVotingSessionMutationHookResult = ReturnType<typeof useCloseVotingSessionMutation>;
export type CloseVotingSessionMutationResult = Apollo.MutationResult<CloseVotingSessionMutation>;
export type CloseVotingSessionMutationOptions = Apollo.BaseMutationOptions<CloseVotingSessionMutation, CloseVotingSessionMutationVariables>;
 ...
 * });
 */
export function useVoteMatchQuery(baseOptions: Apollo.QueryHookOptions<VoteMatchQuery, VoteMatchQueryVariables> & ({ variables: VoteMatchQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<VoteMatchQuery, VoteMatchQueryVariables>(VoteMatchDocument, options);
      }
export function useVoteMatchLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<VoteMatchQuery, VoteMatchQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<VoteMatchQuery, VoteMatchQueryVariables>(VoteMatchDocument, options);
        }
// @ts-ignore
export function useVoteMatchSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<VoteMatchQuery, VoteMatchQueryVariables>): Apollo.UseSuspenseQueryResult<VoteMatchQuery, VoteMatchQueryVariables>;
export function useVoteMatchSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<VoteMatchQuery, VoteMatchQueryVariables>): Apollo.UseSuspenseQueryResult<VoteMatchQuery | undefined, VoteMatchQueryVariables>;
export function useVoteMatchSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<VoteMatchQuery, VoteMatchQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<VoteMatchQuery, VoteMatchQueryVariables>(VoteMatchDocument, options);
        }
export type VoteMatchQueryHookResult = ReturnType<typeof useVoteMatchQuery>;
export type VoteMatchLazyQueryHookResult = ReturnType<typeof useVoteMatchLazyQuery>;
export type VoteMatchSuspenseQueryHookResult = ReturnType<typeof useVoteMatchSuspenseQuery>;
export type VoteMatchQueryResult = Apollo.QueryResult<VoteMatchQuery, VoteMatchQueryVariables>;
 ...
 * });
 */
export function useVotingSessionUpdatedSubscription(baseOptions: Apollo.SubscriptionHookOptions<VotingSessionUpdatedSubscription, VotingSessionUpdatedSubscriptionVariables> & ({ variables: VotingSessionUpdatedSubscriptionVariables; skip?: boolean; } | { skip: boolean; }) ) {
        const options = {...defaultOptions, ...baseOptions}
